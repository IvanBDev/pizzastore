			  ...
			  <div class="container">
			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					    	...
					    	<dl class="row">
					    		<dt class="col-sm-3 text-right">Pizze nell'Ordine:</dt>
					    		<ul class="list-group list-group-flush">
					    			<c:forEach items = "${list_ordine_attr.pizze}" var = "ordineItem">
							  			<li class="list-group-item">${ordineItem.descrizione}</li>
							  		</c:forEach>
					    		</ul>
					    	</dl>
